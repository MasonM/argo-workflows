...
k3d cluster get k3s-default || k3d cluster create --image rancher/k3s:v1.31.2-k3s1 --wait
k3d kubeconfig merge --kubeconfig-merge-default

# install kubectl
curl -LO https://dl.k8s.io/release/v1.31.2/bin/linux/$(go env GOARCH)/kubectl
chmod +x ./kubectl
